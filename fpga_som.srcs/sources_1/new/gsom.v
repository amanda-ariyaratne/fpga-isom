...
module gsom
    ...
    always @(posedge rst) begin
        if (rst) begin
            ...
            k = 0;
            node_count = 0;
            node_count_ieee754 = 32'h00000000;
            t1 = 0;
            t2 = 0;
            init_gsom = 0;
            init_variables = 0;
            ...
            update_error_en = 0;
            update_error_reset = 0;
            new_node_in_middle_en = 0;
            new_node_in_middle_reset = 0;
            new_node_on_one_side_en = 0;
            new_node_on_one_side_reset = 0;
            init_arrays = 1;
        end
    end
